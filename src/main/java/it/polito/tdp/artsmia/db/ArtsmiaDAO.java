...
public class ArtsmiaDAO {
	...
	public int getPeso(ArtObject a1, ArtObject a2) {
		String sql = "SELECT COUNT(*) AS peso FROM  exhibition_objects e1, exhibition_objects e2 WHERE e1.exhibition_id =e2.exhibition_id AND e1.object_id =8485 AND e2.object_id =10421";
	...
	public List<Adiacenza> getAdiacenze() {
		String sql = "SELECT e1.object_id, e2.object_id, COUNT(*) AS peso FROM  exhibition_objects e1, exhibition_objects e2 WHERE e1.exhibition_id =e2.exhibition_id AND e1.object_id > e2.object_id GROUP BY e1.object_id, e2.object_id";
